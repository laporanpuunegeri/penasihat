    ...
    <div class="card shadow-sm p-4 border-0">
        ...
        <form method="POST" action="{{ route('laporanmesyuarat.update', $laporan->id) }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" value="{{ \Carbon\Carbon::parse($laporan->tarikh_mesyuarat)->format('d/m/Y') }}" readonly>
                <input type="hidden" name="tarikh_mesyuarat" value="{{ $laporan->tarikh_mesyuarat }}">
            </div>
