...
<script>
    ...
    // Placeholder: gunakan data sedia ada dahulu untuk modul 5–8
    configBar('grafSemakanUndang', {!! json_encode($dataPandanganUndang) !!});
    configPie('grafMesyuarat', {!! json_encode($dataGubalan) !!});
    configBar('grafTataterib', {!! json_encode($dataKesMahkamah) !!});
    configPie('grafTugasan', {!! json_encode($dataPindaan) !!});
</script>
@endsection
