            ...
            @forelse ($data as $index => $item)
                <tr>
                    ...
                    <td class="text-start">
                        ...
                        {{-- Butang Edit untuk semua pemilik --}}
                        @if ($user->id === $item->user_id)
                            <a href="{{ route('lainlaintugasan.edit', $item->id) }}" class="btn btn-sm btn-warning mb-1">Edit</a>
                        ...
                        {{-- PA boleh edit dan padam jika negeri sama --}}
                        ...
                        {{-- YB atau pengguna lain hanya boleh lihat --}}
                        @else
                            <a href="{{ route('lainlaintugasan.edit', $item->id) }}" class="btn btn-sm btn-warning mb-1">Edit</a>
                        @endif
                    </td>
