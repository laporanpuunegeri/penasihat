...
@php
    $renderRow = function($item, $index, $key, $pecahanMap) {
        ...
        <tr>
            ...
            <td><input type="number" name="data['.$sub.'][kekerapan]" class="input-clean input-freq" value="'.$freq.'" min="0"></td>
...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h3 class="fw-bold text-dark mb-0">OBJEK AM/OBJEK SEBAGAI: OS{{ $kod }} (IKTISAS)</h3>
    ...
    <form method="POST" action="{{ route('pentadbiran.dbus.update_os29000') }}">
        @csrf
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body p-2">
                ...
                <ul class="nav nav-tabs mb-3" id="os29Tab" role="tablist">
                                ...
                                <table class="table table-sm table-pdf mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="10%">KEKERAPAN<br>(KALI/BULAN)</th>
                ...
                <div class="d-flex justify-content-between p-3 mt-3 bg-dark text-white rounded">
                    <h5 class="mb-0">JUMLAH KESELURUHAN (OS29000)</h5>
...
<script>
    ...
    function updateRow(row) {
        ...
        let f = parseFloat(row.querySelector('.input-freq').value) || 0;
        ...
        updateGroupTotal(tbodyId.replace('tbody-', ''));
    }
