...
<style>
    ...
    .waran-card { border-left: 5px solid #1565c0; }
</style>
@endpush
...
<div class="container-fluid py-4">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-5">
        <div>
            <h1 class="h3 mb-0 text-gray-800 fw-bold"><i class="fas fa-desktop me-2"></i> Dashboard Pentadbiran & Kewangan</h1>
            <p class="text-muted mb-0">Ringkasan Waran Perjawatan dan Prestasi Perbelanjaan Tahun {{ $tahun }}</p>
        </div>
    ...
    {{-- ========================================== --}}
    {{-- MODUL 1: WARAN PERJAWATAN (PENTADBIRAN) --}}
    {{-- ========================================== --}}

    @if(isset($waranData) && $waranData->isNotEmpty())
    <h4 class="fw-bold text-primary mb-3"><i class="fas fa-users-cog me-2"></i> Waran Perjawatan (Pentadbiran)</h4>
    <div class="row g-4 mb-5">
        
        {{-- KAD 1: KIRAAN WARAN --}}
        <div class="col-md-4">
            <div class="card shadow-sm waran-card">
                <div class="card-body">
                    <h6 class="text-uppercase text-secondary small">Jumlah Perjawatan (Waran)</h6>
                    <h2 class="fw-bold text-primary">{{ $metadata['totalWaran'] ?? 0 }}</h2>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card shadow-sm waran-card">
                <div class="card-body">
                    <h6 class="text-uppercase text-secondary small">Bilangan Diisi</h6>
                    <h2 class="fw-bold text-success">{{ $metadata['totalIsi'] ?? 0 }}</h2>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card shadow-sm waran-card">
                <div class="card-body">
                    <h6 class="text-uppercase text-secondary small">Bilangan Kosong</h6>
                    <h2 class="fw-bold text-danger">{{ $metadata['totalKosong'] ?? 0 }}</h2>
                </div>
            </div>
        </div>
    </div>
    ...
    {{-- ========================================== --}}
    {{-- MODUL 2: PRESTASI KEWANGAN --}}
    {{-- ========================================== --}}

    <h4 class="fw-bold text-primary mb-3"><i class="fas fa-chart-bar me-2"></i> Prestasi Perbelanjaan (Kewangan)</h4>
    <div class="row g-4">
        ...
        @else
            <div class="col-12 text-center py-5">
                <div class="text-muted">Data kewangan tidak dijumpai.</div>
            </div>
        @endif
    </div>
