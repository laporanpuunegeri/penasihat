...
<div class="container-fluid px-4">
    <h5 class="fw-bold text-center text-uppercase mb-4">
        Laporan Penyemakan Rang Undang-Undang / Perundangan Subsidiari Substantif / Pemberitahuan Awam (G.N)<br>
                    ...
                    <tr>
                        ...
                        <td class="text-start">
                            ...
                            <div class="small text-muted fst-italic mb-1">
                                {{ optional($laporan->user)->name ?? 'Pengguna Tidak Dikenal Pasti' }}
                            </div>
