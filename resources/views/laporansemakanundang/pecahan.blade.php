    ...
    <div class="d-flex justify-content-between align-items-center mb-5">
        <div>
            <h2 class="fw-bold text-primary text-uppercase" style="letter-spacing: 1px;">
                Semakan: {{ $namaBulan }} {{ $tahun }}
            </h2>
            <p class="text-muted mb-0">Statistik pecahan semakan mengikut tajuk perundangan.</p>
        </div>
            ...
            <div class="card shadow-sm border-0 h-100" style="border-radius: 12px;">
                <div class="card-header bg-white border-bottom border-light py-3">
                    <h5 class="card-title text-primary mb-0 fw-bold">
                        <i class="fas fa-chart-pie me-2"></i> Carta Semakan
                    </h5>
                </div>
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover mb-0 align-middle">
                            <thead class="bg-light">
                                <tr>
                                    <th class="ps-4 py-3">Tajuk / Kategori</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    {{-- Controller dah mapkan nama jadi 'kategori' --}}
                                ...
                                @empty
                                <tr>
                                    <td colspan="2" class="text-center py-4 text-muted">Tiada rekod.</td>
                                </tr>
                                @endforelse
                            </tbody>
