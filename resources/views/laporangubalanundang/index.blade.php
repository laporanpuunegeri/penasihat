...
<div class="container-fluid px-4 py-4">
    ...
    <div class="page-header d-flex flex-wrap justify-content-between align-items-center gap-3">
        <div>
            <h3 class="mb-1 fw-bold text-dark">Laporan Penggubalan Undang-Undang</h3>
            <p class="text-muted small mb-0">Senarai Rang Undang-Undang / Perundangan Subsidiari & Pemberitahuan Awam.</p>
        </div>
        
        <div class="d-flex gap-2">
            <a href="{{ url('/laporangubalanundang/create') }}" class="btn btn-primary shadow-sm px-4">
                <i class="fas fa-plus-circle me-2"></i> Daftar Gubalan
            </a>
        </div>
    </div>
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-body py-3 px-4">
            <form method="GET" action="{{ url('/laporangubalanundang') }}" class="row align-items-center g-3">
                <div class="col-auto">
                ...
                @if(request('bulan'))
                <div class="col-auto">
                    <a href="{{ url('/laporangubalanundang') }}" class="btn btn-outline-secondary btn-sm rounded-pill px-3">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-center gap-2">
                                    {{-- Edit --}}
                                    <a href="{{ url('/laporangubalanundang/' . $laporan->id . '/edit') }}" 
                                    ...
                                    @if ($currentUser->id === $laporan->user_id || $currentUser->role === 'admin')
                                        <form action="{{ url('/laporangubalanundang/' . $laporan->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Anda pasti untuk padam rekod ini?');">
                                            @csrf
                                            @method('DELETE')
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="text-center py-5 text-muted bg-light">
                                ...
                                <p class="mb-0 fw-bold">Tiada rekod penggubalan ditemui.</p>
                                <small>Sila klik butang "Daftar Gubalan" untuk mula.</small>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
