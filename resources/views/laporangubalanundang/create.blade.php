...
<div class="container-fluid px-4 py-4">
    ...
    <div class="page-header d-flex justify-content-between align-items-center">
        <div>
            <h3 class="mb-1 fw-bold text-dark">Daftar Gubalan</h3>
            <p class="text-muted small mb-0">Daftar Rang Undang-Undang atau Perundangan Subsidiari baru.</p>
        </div>
    ...
    <form method="POST" action="{{ route('laporangubalanundang.store') }}">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="form-card p-4 mb-4">
                    <h5 class="form-section-title"><i class="fas fa-file-alt me-2 text-primary"></i> Maklumat Gubalan</h5>

                    <div class="mb-4">
                        <label for="tajuk" class="form-label">Tajuk RUU / Perundangan Subsidiari</label>
                        <textarea name="tajuk" id="tajuk" class="form-control fs-6" rows="3" placeholder="Masukkan tajuk penuh perundangan..." required>{{ old('tajuk') }}</textarea>
                    </div>
                ...
                <div class="form-card p-4 mb-4">
                    ...
                    <div class="mb-2">
                        ...
                        <select id="status_preset" class="form-select form-select-sm bg-light mb-2">
                            ...
                            <option value="Draf RUU telah dikemukakan kepada (Agensi) pada ...">1. Draf dikemukakan ke Agensi</option>
                            <option value="Draf Undang-Undang Kecil telah dikemukakan kepada (Agensi) pada ...">2. Draf UUK dikemukakan ke Agensi</option>
        ...
        <div class="d-flex justify-content-end mt-3 mb-5">
            ...
            <button type="submit" class="btn btn-success px-5 py-2 shadow fw-bold">
                <i class="fas fa-save me-2"></i> Simpan Gubalan
            </button>
        </div>
